...
document.addEventListener('DOMContentLoaded', function,// เพิ่มคลาสให้ body สำหรับธีม
document.body.classList.add('theme-dark');

// ตรวจสอบว่าองค์ประกอบหลักมีคลาสที่ถูกต้อง
function ensureTheme() {
  const containers = document.querySelectorAll('.container, .main-content, section, .analysis-container');
  ...
  // ปรับการ์ดทุกใบ
  document.querySelectorAll('.card, .box, .layer, .result').forEach(el => {
...
// เรียกใช้ทันทีและทุกครั้งที่ DOM เปลี่ยน
ensureTheme();

// ใช้ MutationObserver เผื่อมีเนื้อหาโหลดเพิ่ม
const observer = new MutationObserver(() => ensureTheme());
